...
for f in range(iterations):
    ...
    numpy_img = window.get_image_buffer_as_numpy()
    video_manager.write_frame(numpy_img)

video_manager.make_video(gif=True, mp4=True)
old_mp4 = os.path.join(output_dir, "video.mp4")
new_mp4 = os.path.join(output_dir, "physical_simulation.mp4")
